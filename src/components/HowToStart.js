    ...
    <Card id="how-to-start" sx={{ maxWidth: 600, margin: '20px auto' }}>
      <CardContent>
        ...
        <Typography variant="body2" color="text.secondary" align="left">
          ...
          <p>После покупки USDT не забудьте перевести их из кошелька для пополнения на единый торговый счет вашего аккаунта на Bybit.</p>
          ...
          <p>
            ...
            {/* Для webApp */}
            {/* После этого вам необходимо вернуться в телеграм бот
            , выбрать раздел «Подключить счет» и далее следовать указаниям бота. После подключения счета торговля начнется автоматически.
            <WebApp /> */}
          </p>
        </Typography>
      </CardContent>
